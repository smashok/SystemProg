...
void Car::output()  {
        cout << "Car Info" << endl
            <<"LastTODate: " << getLastTODate() << endl
            <<"BrandCode: " << getBrandCode() << endl
            <<"RegistrationNumber: " << getRegistrationNumber() << endl
            <<"BodyNumber: " << getBodyNumber() << endl
            <<"EngineNumber: " << getEngineNumber() << endl
            <<"CreatedYear: " << getCreatedYear() << endl
            <<"Mileage(: " << getMileage() << endl
            <<"SpecialMarks: " << getSpecialMarks() 
            << endl;
